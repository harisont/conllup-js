...
export declare const tabLabel_Ts: string[];
...
export declare const _tokenJsonToConll: (tokenJson: tokenJson_T, features?: string[]) => string;
export declare const _treeJsonToConll: (treeJson: treeJson_T, features?: string[]) => string;
export declare const _metaJsonToConll: (metaJson: metaJson_T) => string;
export declare const sentenceJsonToConll: (sentenceJson: sentenceJson_T, features?: string[]) => string;
