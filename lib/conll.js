...
exports.tabLabel_Ts = ['ID', 'FORM', 'LEMMA', 'UPOS', 'XPOS', 'FEATS', 'HEAD', 'DEPREL', 'DEPS', 'MISC'];
...
const _tokenJsonToConll = (tokenJson, features = exports.tabLabel_Ts) => {
...
const _treeJsonToConll = (treeJson, features = exports.tabLabel_Ts) => {
    ...
    for (const tokenIndex of sortedTokenIndexes) {
        ...
        const tokenConll = (0, exports._tokenJsonToConll)(tokenJson, features);
...
const sentenceJsonToConll = (sentenceJson, features = exports.tabLabel_Ts) => {
    const metaConll = (0, exports._metaJsonToConll)(sentenceJson.metaJson);
    const treeConll = (0, exports._treeJsonToConll)(sentenceJson.treeJson, features);
    if (metaConll === '') {
        return treeConll;
    }
    return `${metaConll}\n${treeConll}`;
...
const returnTokensInOrder = (treeJson, includeEnhanced = false, includeGroup = false) => {
    ...
    combinedArray.sort((token1, token2) => (0, exports._compareTokenIndexes)(token1.ID, token2.ID));
    return combinedArray;
};
exports.returnTokensInOrder = returnTokensInOrder;
const getNodeFromTreeJson = (treeJson, nodeIndex, throwErrorIfMissing = false) => {
...
exports.getNodeFromTreeJson = getNodeFromTreeJson;
